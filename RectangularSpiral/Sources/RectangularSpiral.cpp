...
int CreatePath(struct UDPFunctionLib* functionLib, void* callbackData, double* paramValues, struct UDPPosition* startPt, struct UDPPosition* endPt);
int CreateProfile(struct UDPFunctionLib* functionLib, void* callbackData, double* paramValues);
...
int CreatePrimitive(struct UDPFunctionLib* functionLib, void* callbackData, double* paramValues)
{
    ...
    int path = CreatePath(functionLib, callbackData, paramValues, &startPt, &endPt);
    ...
    // The profile
    int profile = CreateProfile(functionLib, callbackData, paramValues);
    ...
    int success = functionLib->sweepAlongPath(profile, path, &sweepOptions, callbackData);
...
int CreatePath(struct UDPFunctionLib* functionLib, void* callbackData, double* paramValues, struct UDPPosition* startPt, struct UDPPosition* endPt)
{
    ...
    int path = functionLib->createPolyline(&polylineDefinition, callbackData);
...
int CreateProfile(struct UDPFunctionLib* functionLib, void* callbackData, double* paramValues)
{
    ...
    polylineDefinition.isClosed = 1;

    int profile = functionLib->createPolyline(&polylineDefinition, callbackData);
